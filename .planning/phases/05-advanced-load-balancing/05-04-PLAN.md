...
<task type="auto">
  ...
  <action>
    ...
    3. When gpu_weighted enabled:
       - Use weighted file assignment in DNABERT-S and ESM-2 stages
       - Pass use_weighted_assignment=True to assign_files_by_sequences
    4. When show_gpu_dashboard enabled (and parallel):
       - Create and start LoadBalancingDashboard
    ...
    - In file assignment: apply GPU weights if gpu_weighted
  ...
  <done>Pipeline integrates work stealing coordinator and dashboard when enabled</done>
</task>
...
- Dashboard displays when requested
- Workers can steal from shared queues
- GPU weights applied to file assignment
</verification>
