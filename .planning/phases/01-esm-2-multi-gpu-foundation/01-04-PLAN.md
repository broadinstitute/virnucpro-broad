...
<task type="auto">
  ...
  <action>
    ...
    Use subprocess to test full CLI integration.
...
<task type="auto">
  ...
  <action>
    ...
    - **Load balancing**: Files distributed based on sequence count
    ...
    ### Uneven GPU Usage
    - Files are distributed based on sequence count, not file count
