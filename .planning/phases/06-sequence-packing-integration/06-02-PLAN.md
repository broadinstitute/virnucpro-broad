...
2. Validate cu_seqlens is int32 (required by flash-attn)
3. Validate q/k/v are FP16 or BF16 (FlashAttention requirement)
4. Call flash_attn_varlen_func with cu_seqlens_q=cu_seqlens_k=cu_seqlens
5. Handle ImportError gracefully with helpful message about installation
