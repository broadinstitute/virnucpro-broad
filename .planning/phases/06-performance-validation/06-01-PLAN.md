...
<task type="auto">
  ...
  <action>
    ...
    2. In tests/benchmarks/conftest.py:
       ...
       - Create gpu_monitor fixture using enhanced GPU monitoring
    ...
    Import existing virnucpro.utils.gpu_monitor for memory tracking.
  </action>
...
<task type="auto">
  ...
  <done>GPU monitoring enhanced with nvitop support and benchmark-specific metrics</done>
</task>
...
- GPU monitoring captures utilization and memory metrics
...
- GPU monitor tracks metrics (falls back gracefully if no GPU)
