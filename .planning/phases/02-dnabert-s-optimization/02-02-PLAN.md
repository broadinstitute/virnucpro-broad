...
<objective>
Refactor ESM-2 worker to use BaseEmbeddingWorker and create comprehensive tests for DNABERT-S parallel processing.

Purpose: Ensure consistency between workers through shared base class and validate DNABERT-S implementation with thorough testing.
...
<task type="auto">
  ...
  <verify>python -m pytest tests/test_parallel_dnabert.py -v --tb=short</verify>
  <done>test_parallel_dnabert.py created with comprehensive test coverage for DNABERT-S worker</done>
</task>
