...
must_haves:
  truths:
    - "BaseEmbeddingWorker abstract class defines unified interface"
    - "DNABERT-S parallel worker processes files on multiple GPUs"
    - "Token-based batching abstracts k-mer complexity"
